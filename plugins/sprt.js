...
r_text[1] = "Jimbrootane tholpikkaan ningalkavilla. Jeevitathil Jimbrootane tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
...
r_text[13] = ".song adich thangalude fav song name para Jimbrootan ath download aakki theraam";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe Jimbrootan pazhaya Jimbrootan thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik Jimbrootanu";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee Jimbrootan";
...
Asena.addCommand({pattern: 'bot', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
    ...
    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "Jimbrootane tholpikkaan ningalkavilla. Jeevitathil pinkiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Jimbrootan says i love you 😘";
r_text[3] = "Jimbrootante yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
